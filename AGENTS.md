...
| `20_Gate_Assessment_Design.md` | QG0-QG5 gate assessment model and checklist result design |
| `21_AI_Agent_Integration_Spec.md` | AI Agent submission flow for proposed assessment results |
| `22_Audit_Report_And_Lifecycle_Maturity_Design.md` | Audit report views, Activity x Gate model, lifecycle maturity scoring |
